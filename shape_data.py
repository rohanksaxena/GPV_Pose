    ...
    for subset in ['val']:
        ...
        for synsetId in ['02876657', '02880940', '02942699', '02946921', '03642806', '03797390']:
            ...
            for instance in inst_list:
                print('synset: ', synsetId)
                print('instance: ', instance)
                # skip problematic instance
                if synsetId == '02876657' and instance == 'd3b53f56b4a7b3b3c9f016d57db96408':
                    print('skipping instance d3b53f56b4a7b3b3c9f016d57db96408')
                    continue
                path_to_mesh_model = os.path.join(synset_dir, instance, 'model.obj')
                print("path to mesh model: ", path_to_mesh_model)
...
if __name__ == '__main__':
    ...
    print('obj_model_dir: ', obj_model_dir)
